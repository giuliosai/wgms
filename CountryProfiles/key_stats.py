...
glacier_A_path = os.path.join(data_dir, "fog_glacier_area.csv")

glaciers_df_2015v = pd.read_csv(glaciers_df_2015v_path, encoding = 'latin-1')
fv_reco_df_2015v = pd.read_csv(fv_reco_df_2015v_path, encoding = 'latin-1')
mb_df_overview_2015v = pd.read_csv(mb_df_overview_2015v_path, encoding = 'latin-1')
change_df_2015v = pd.read_csv(change_df_2015v_path, encoding = 'latin-1')
...
glaciers_df = pd.read_csv(glaciers_df_path, dtype = {'POLITICAL_UNIT': str})
country_names = pd.read_csv(country_names_path).set_index('id')['name'].to_dict()
fronts_df_2015v = pd.read_csv(fronts_df_2015v_path, encoding = 'latin-1')
glacier_A = pd.read_csv(glacier_A_path)

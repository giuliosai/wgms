...
glims_points_path = os.path.join(data_dir, "glims_point.gpkg")
countries_path = os.path.join(data_dir, "country.gpkg")
rgi7_path = os.path.join(data_dir, "rgi7.gpkg")
wgi_path  = os.path.join(data_dir, "wgi.csv")

glims_points = gpd.read_file(glims_points_path)
